...
dd  C_LABEL(OpX0_0xAE)    ,C_LABEL(E0_LDA_al)
...
dd  C_LABEL(OpX0_0xAE)    ,C_LABEL(EM_LDA_al)
...
dd  C_LABEL(OpX1_0xAE)    ,C_LABEL(E0_LDA_al)
...
dd  C_LABEL(OpX1_0xAE)    ,C_LABEL(EM_LDA_al)
