...
dd  C_LABEL(OpX0_0xC8)    ,C_LABEL(E0_CMP_i)
...
dd  C_LABEL(OpX0_0xE8)    ,C_LABEL(E0_SBC_i)
...
dd  C_LABEL(OpX0_0xC8)    ,C_LABEL(EM_CMP_i)
dd  C_LABEL(OpX0_0xCA)    ,C_LABEL(ALL_WAI)
...
dd  C_LABEL(OpX0_0xE8)    ,C_LABEL(EM_SBC_i)
dd  C_LABEL(ALL_NOP)      ,C_LABEL(ALL_XBA)
...
dd  C_LABEL(E0_DEC_d)     ,C_LABEL(E0_CMP_IdI)
dd  C_LABEL(OpX1_0xC8)    ,C_LABEL(E0_CMP_i)
...
dd  C_LABEL(E0_INC_d)     ,C_LABEL(E0_SBC_IdI)
dd  C_LABEL(OpX1_0xE8)    ,C_LABEL(E0_SBC_i)
dd  C_LABEL(ALL_NOP)      ,C_LABEL(ALL_XBA)
...
dd  C_LABEL(EM_DEC_d)     ,C_LABEL(EM_CMP_IdI)
dd  C_LABEL(OpX1_0xC8)    ,C_LABEL(EM_CMP_i)
dd  C_LABEL(OpX1_0xCA)    ,C_LABEL(ALL_WAI)
...
dd  C_LABEL(EM_INC_d)     ,C_LABEL(EM_SBC_IdI)
dd  C_LABEL(OpX1_0xE8)    ,C_LABEL(EM_SBC_i)
dd  C_LABEL(ALL_NOP)      ,C_LABEL(ALL_XBA)
