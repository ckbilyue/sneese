...
dd  C_LABEL(E0_COP)       ,C_LABEL(E0_ORA_d_s)
dd  C_LABEL(E0_TSB_d)     ,C_LABEL(E0_ORA_d)
dd  C_LABEL(E0_ASL_d)     ,C_LABEL(E0_ORA_IdI)
dd  C_LABEL(E0_PHP)       ,C_LABEL(E0_ORA_i)
dd  C_LABEL(E0_SLA)       ,C_LABEL(E0_PHD)
dd  C_LABEL(E0_TSB_a)     ,C_LABEL(E0_ORA_a)
dd  C_LABEL(E0_ASL_a)     ,C_LABEL(E0_ORA_al)
dd  C_LABEL(ALL_BPL)      ,C_LABEL(E0_ORA_OdO_y)    ; 10
dd  C_LABEL(E0_ORA_OdO)   ,C_LABEL(E0_ORA_Od_sO_y)
dd  C_LABEL(E0_TRB_d)     ,C_LABEL(E0_ORA_d_x)
dd  C_LABEL(E0_ASL_d_x)   ,C_LABEL(E0_ORA_IdI_y)
dd  C_LABEL(ALL_CLC)      ,C_LABEL(E0_ORA_a_y)
dd  C_LABEL(E0_INA)       ,C_LABEL(E0_TCS)
dd  C_LABEL(E0_TRB_a)     ,C_LABEL(E0_ORA_a_x)
dd  C_LABEL(E0_ASL_a_x)   ,C_LABEL(E0_ORA_al_x)
dd  C_LABEL(E0_JSR_a)     ,C_LABEL(E0_AND_Od_xO)    ; 20
dd  C_LABEL(E0_JSL_al)    ,C_LABEL(E0_AND_d_s)
dd  C_LABEL(E0_BIT_d)     ,C_LABEL(E0_AND_d)
dd  C_LABEL(E0_ROL_d)     ,C_LABEL(E0_AND_IdI)
dd  C_LABEL(E0_PLP)       ,C_LABEL(E0_AND_i)
dd  C_LABEL(E0_RLA)       ,C_LABEL(E0_PLD)
dd  C_LABEL(E0_BIT_a)     ,C_LABEL(E0_AND_a)
dd  C_LABEL(E0_ROL_a)     ,C_LABEL(E0_AND_al)
dd  C_LABEL(ALL_BMI)      ,C_LABEL(E0_AND_OdO_y)    ; 30
dd  C_LABEL(E0_AND_OdO)   ,C_LABEL(E0_AND_Od_sO_y)
dd  C_LABEL(E0_BIT_d_x)   ,C_LABEL(E0_AND_d_x)
dd  C_LABEL(E0_ROL_d_x)   ,C_LABEL(E0_AND_IdI_y)
dd  C_LABEL(ALL_SEC)      ,C_LABEL(E0_AND_a_y)
dd  C_LABEL(E0_DEA)       ,C_LABEL(ALL_TSC)
dd  C_LABEL(E0_BIT_a_x)   ,C_LABEL(E0_AND_a_x)
dd  C_LABEL(E0_ROL_a_x)   ,C_LABEL(E0_AND_al_x)
dd  C_LABEL(E0_RTI)       ,C_LABEL(E0_EOR_Od_xO)    ; 40
dd  C_LABEL(ALL_INVALID)  ,C_LABEL(E0_EOR_d_s)
dd  C_LABEL(E0_MVP)       ,C_LABEL(E0_EOR_d)
dd  C_LABEL(E0_LSR_d)     ,C_LABEL(E0_EOR_IdI)
dd  C_LABEL(E0_PHA)       ,C_LABEL(E0_EOR_i)
dd  C_LABEL(E0_SRA)       ,C_LABEL(E0_PHK)
dd  C_LABEL(ALL_JMP_a)    ,C_LABEL(E0_EOR_a)
dd  C_LABEL(E0_LSR_a)     ,C_LABEL(E0_EOR_al)
dd  C_LABEL(ALL_BVC)      ,C_LABEL(E0_EOR_OdO_y)    ; 50
dd  C_LABEL(E0_EOR_OdO)   ,C_LABEL(E0_EOR_Od_sO_y)
dd  C_LABEL(E0_MVN)       ,C_LABEL(E0_EOR_d_x)
dd  C_LABEL(E0_LSR_d_x)   ,C_LABEL(E0_EOR_IdI_y)
dd  C_LABEL(E0_CLI)       ,C_LABEL(E0_EOR_a_y)
dd  C_LABEL(E0_PHY)       ,C_LABEL(ALL_TCD)
dd  C_LABEL(ALL_JML_al)   ,C_LABEL(E0_EOR_a_x)
dd  C_LABEL(E0_LSR_a_x)   ,C_LABEL(E0_EOR_al_x)
dd  C_LABEL(E0_RTS)       ,C_LABEL(E0_ADC_Od_xO)    ; 60
dd  C_LABEL(E0_PER)       ,C_LABEL(E0_ADC_d_s)
dd  C_LABEL(E0_STZ_d)     ,C_LABEL(E0_ADC_d)
dd  C_LABEL(E0_ROR_d)     ,C_LABEL(E0_ADC_IdI)
dd  C_LABEL(E0_PLA)       ,C_LABEL(E0_ADC_i)
dd  C_LABEL(E0_RRA)       ,C_LABEL(E0_RTL)
dd  C_LABEL(ALL_JMP_OaO)  ,C_LABEL(E0_ADC_a)
dd  C_LABEL(E0_ROR_a)     ,C_LABEL(E0_ADC_al)
...
dd  C_LABEL(E0_ROR_d_x)   ,C_LABEL(E0_ADC_IdI_y)
dd  C_LABEL(ALL_SEI)      ,C_LABEL(E0_ADC_a_y)
dd  C_LABEL(E0_PLY)       ,C_LABEL(ALL_TDC)
dd  C_LABEL(ALL_JMP_Oa_xO),C_LABEL(E0_ADC_a_x)
dd  C_LABEL(E0_ROR_a_x)   ,C_LABEL(E0_ADC_al_x)
dd  C_LABEL(ALL_BRA)      ,C_LABEL(E0_STA_Od_xO)    ; 80
dd  C_LABEL(ALL_BRL)      ,C_LABEL(E0_STA_d_s)
dd  C_LABEL(E0_STY_d)     ,C_LABEL(E0_STA_d)
dd  C_LABEL(E0_STX_d)     ,C_LABEL(E0_STA_IdI)
dd  C_LABEL(E0_DEY)       ,C_LABEL(E0_BIT_i)
dd  C_LABEL(E0_TXA)       ,C_LABEL(E0_PHB)
dd  C_LABEL(E0_STY_a)     ,C_LABEL(E0_STA_a)
dd  C_LABEL(E0_STX_a)     ,C_LABEL(E0_STA_al)
dd  C_LABEL(ALL_BCC)      ,C_LABEL(E0_STA_OdO_y)    ; 90
dd  C_LABEL(E0_STA_OdO)   ,C_LABEL(E0_STA_Od_sO_y)
dd  C_LABEL(E0_STY_d_x)   ,C_LABEL(E0_STA_d_x)
dd  C_LABEL(E0_STX_d_y)   ,C_LABEL(E0_STA_IdI_y)
...
dd  C_LABEL(E0_TAY)       ,C_LABEL(E0_LDA_i)
dd  C_LABEL(E0_TAX)       ,C_LABEL(E0_PLB)
dd  C_LABEL(E0_LDY_a)     ,C_LABEL(E0_LDA_a)
dd  C_LABEL(E0_LDX_a)     ,C_LABEL(E0_LDA_al)
dd  C_LABEL(ALL_BCS)      ,C_LABEL(E0_LDA_OdO_y)    ; B0
dd  C_LABEL(E0_LDA_OdO)   ,C_LABEL(E0_LDA_Od_sO_y)
...
dd  C_LABEL(E0_CPY_i)     ,C_LABEL(E0_CMP_Od_xO)    ; C0
dd  C_LABEL(E0_REP)       ,C_LABEL(E0_CMP_d_s)
dd  C_LABEL(E0_CPY_d)     ,C_LABEL(E0_CMP_d)
dd  C_LABEL(E0_DEC_d)     ,C_LABEL(E0_CMP_IdI)
dd  C_LABEL(E0_INY)       ,C_LABEL(E0_CMP_i)
dd  C_LABEL(E0_DEX)       ,C_LABEL(ALL_WAI)
dd  C_LABEL(E0_CPY_a)     ,C_LABEL(E0_CMP_a)
dd  C_LABEL(E0_DEC_a)     ,C_LABEL(E0_CMP_al)
dd  C_LABEL(ALL_BNE)      ,C_LABEL(E0_CMP_OdO_y)    ; D0
dd  C_LABEL(E0_CMP_OdO)   ,C_LABEL(E0_CMP_Od_sO_y)
dd  C_LABEL(E0_PEI)       ,C_LABEL(E0_CMP_d_x)
dd  C_LABEL(E0_DEC_d_x)   ,C_LABEL(E0_CMP_IdI_y)
dd  C_LABEL(ALL_CLD)      ,C_LABEL(E0_CMP_a_y)
dd  C_LABEL(E0_PHX)       ,C_LABEL(ALL_INVALID)
dd  C_LABEL(ALL_JML_OaO)  ,C_LABEL(E0_CMP_a_x)
dd  C_LABEL(E0_DEC_a_x)   ,C_LABEL(E0_CMP_al_x)
dd  C_LABEL(E0_CPX_i)     ,C_LABEL(E0_SBC_Od_xO)    ; E0
dd  C_LABEL(E0_SEP)       ,C_LABEL(E0_SBC_d_s)
dd  C_LABEL(E0_CPX_d)     ,C_LABEL(E0_SBC_d)
dd  C_LABEL(E0_INC_d)     ,C_LABEL(E0_SBC_IdI)
dd  C_LABEL(E0_INX)       ,C_LABEL(E0_SBC_i)
dd  C_LABEL(ALL_NOP)      ,C_LABEL(ALL_XBA)
dd  C_LABEL(E0_CPX_a)     ,C_LABEL(E0_SBC_a)
dd  C_LABEL(E0_INC_a)     ,C_LABEL(E0_SBC_al)
dd  C_LABEL(ALL_BEQ)      ,C_LABEL(E0_SBC_OdO_y)    ; F0
dd  C_LABEL(E0_SBC_OdO)   ,C_LABEL(E0_SBC_Od_sO_y)
dd  C_LABEL(E0_PEA)       ,C_LABEL(E0_SBC_d_x)
dd  C_LABEL(E0_INC_d_x)   ,C_LABEL(E0_SBC_IdI_y)
dd  C_LABEL(ALL_SED)      ,C_LABEL(E0_SBC_a_y)
dd  C_LABEL(E0_PLX)       ,C_LABEL(E0_XCE)
dd  C_LABEL(E0_JSR_Oa_xO) ,C_LABEL(E0_SBC_a_x)
dd  C_LABEL(E0_INC_a_x)   ,C_LABEL(E0_SBC_al_x)
...
dd  C_LABEL(E0_COP)       ,C_LABEL(EM_ORA_d_s)
dd  C_LABEL(EM_TSB_d)     ,C_LABEL(EM_ORA_d)
dd  C_LABEL(EM_ASL_d)     ,C_LABEL(EM_ORA_IdI)
dd  C_LABEL(E0_PHP)       ,C_LABEL(EM_ORA_i)
dd  C_LABEL(EM_SLA)       ,C_LABEL(E0_PHD)
dd  C_LABEL(EM_TSB_a)     ,C_LABEL(EM_ORA_a)
dd  C_LABEL(EM_ASL_a)     ,C_LABEL(EM_ORA_al)
dd  C_LABEL(ALL_BPL)      ,C_LABEL(EM_ORA_OdO_y)    ; 10
dd  C_LABEL(EM_ORA_OdO)   ,C_LABEL(EM_ORA_Od_sO_y)
dd  C_LABEL(EM_TRB_d)     ,C_LABEL(EM_ORA_d_x)
dd  C_LABEL(EM_ASL_d_x)   ,C_LABEL(EM_ORA_IdI_y)
dd  C_LABEL(ALL_CLC)      ,C_LABEL(EM_ORA_a_y)
dd  C_LABEL(EM_INA)       ,C_LABEL(E0_TCS)
dd  C_LABEL(EM_TRB_a)     ,C_LABEL(EM_ORA_a_x)
dd  C_LABEL(EM_ASL_a_x)   ,C_LABEL(EM_ORA_al_x)
dd  C_LABEL(E0_JSR_a)     ,C_LABEL(EM_AND_Od_xO)    ; 20
dd  C_LABEL(E0_JSL_al)    ,C_LABEL(EM_AND_d_s)
dd  C_LABEL(EM_BIT_d)     ,C_LABEL(EM_AND_d)
dd  C_LABEL(EM_ROL_d)     ,C_LABEL(EM_AND_IdI)
dd  C_LABEL(E0_PLP)       ,C_LABEL(EM_AND_i)
dd  C_LABEL(EM_RLA)       ,C_LABEL(E0_PLD)
dd  C_LABEL(EM_BIT_a)     ,C_LABEL(EM_AND_a)
dd  C_LABEL(EM_ROL_a)     ,C_LABEL(EM_AND_al)
dd  C_LABEL(ALL_BMI)      ,C_LABEL(EM_AND_OdO_y)    ; 30
dd  C_LABEL(EM_AND_OdO)   ,C_LABEL(EM_AND_Od_sO_y)
dd  C_LABEL(EM_BIT_d_x)   ,C_LABEL(EM_AND_d_x)
dd  C_LABEL(EM_ROL_d_x)   ,C_LABEL(EM_AND_IdI_y)
dd  C_LABEL(ALL_SEC)      ,C_LABEL(EM_AND_a_y)
dd  C_LABEL(EM_DEA)       ,C_LABEL(ALL_TSC)
dd  C_LABEL(EM_BIT_a_x)   ,C_LABEL(EM_AND_a_x)
dd  C_LABEL(EM_ROL_a_x)   ,C_LABEL(EM_AND_al_x)
dd  C_LABEL(E0_RTI)       ,C_LABEL(EM_EOR_Od_xO)    ; 40
dd  C_LABEL(ALL_INVALID)  ,C_LABEL(EM_EOR_d_s)
dd  C_LABEL(E0_MVP)       ,C_LABEL(EM_EOR_d)
dd  C_LABEL(EM_LSR_d)     ,C_LABEL(EM_EOR_IdI)
dd  C_LABEL(EM_PHA)       ,C_LABEL(EM_EOR_i)
dd  C_LABEL(EM_SRA)       ,C_LABEL(E0_PHK)
dd  C_LABEL(ALL_JMP_a)    ,C_LABEL(EM_EOR_a)
dd  C_LABEL(EM_LSR_a)     ,C_LABEL(EM_EOR_al)
dd  C_LABEL(ALL_BVC)      ,C_LABEL(EM_EOR_OdO_y)    ; 50
dd  C_LABEL(EM_EOR_OdO)   ,C_LABEL(EM_EOR_Od_sO_y)
dd  C_LABEL(E0_MVN)       ,C_LABEL(EM_EOR_d_x)
dd  C_LABEL(EM_LSR_d_x)   ,C_LABEL(EM_EOR_IdI_y)
dd  C_LABEL(E0_CLI)       ,C_LABEL(EM_EOR_a_y)
dd  C_LABEL(E0_PHY)       ,C_LABEL(ALL_TCD)
dd  C_LABEL(ALL_JML_al)   ,C_LABEL(EM_EOR_a_x)
dd  C_LABEL(EM_LSR_a_x)   ,C_LABEL(EM_EOR_al_x)
dd  C_LABEL(E0_RTS)       ,C_LABEL(EM_ADC_Od_xO)    ; 60
dd  C_LABEL(E0_PER)       ,C_LABEL(EM_ADC_d_s)
dd  C_LABEL(EM_STZ_d)     ,C_LABEL(EM_ADC_d)
dd  C_LABEL(EM_ROR_d)     ,C_LABEL(EM_ADC_IdI)
dd  C_LABEL(EM_PLA)       ,C_LABEL(EM_ADC_i)
dd  C_LABEL(EM_RRA)       ,C_LABEL(E0_RTL)
dd  C_LABEL(ALL_JMP_OaO)  ,C_LABEL(EM_ADC_a)
dd  C_LABEL(EM_ROR_a)     ,C_LABEL(EM_ADC_al)
...
dd  C_LABEL(EM_ROR_d_x)   ,C_LABEL(EM_ADC_IdI_y)
dd  C_LABEL(ALL_SEI)      ,C_LABEL(EM_ADC_a_y)
dd  C_LABEL(E0_PLY)       ,C_LABEL(ALL_TDC)
dd  C_LABEL(ALL_JMP_Oa_xO),C_LABEL(EM_ADC_a_x)
dd  C_LABEL(EM_ROR_a_x)   ,C_LABEL(EM_ADC_al_x)
dd  C_LABEL(ALL_BRA)      ,C_LABEL(EM_STA_Od_xO)    ; 80
dd  C_LABEL(ALL_BRL)      ,C_LABEL(EM_STA_d_s)
dd  C_LABEL(E0_STY_d)     ,C_LABEL(EM_STA_d)
dd  C_LABEL(E0_STX_d)     ,C_LABEL(EM_STA_IdI)
dd  C_LABEL(E0_DEY)       ,C_LABEL(EM_BIT_i)
dd  C_LABEL(EM_TXA)       ,C_LABEL(E0_PHB)
dd  C_LABEL(E0_STY_a)     ,C_LABEL(EM_STA_a)
dd  C_LABEL(E0_STX_a)     ,C_LABEL(EM_STA_al)
dd  C_LABEL(ALL_BCC)      ,C_LABEL(EM_STA_OdO_y)    ; 90
dd  C_LABEL(EM_STA_OdO)   ,C_LABEL(EM_STA_Od_sO_y)
dd  C_LABEL(E0_STY_d_x)   ,C_LABEL(EM_STA_d_x)
dd  C_LABEL(E0_STX_d_y)   ,C_LABEL(EM_STA_IdI_y)
...
dd  C_LABEL(E0_TAY)       ,C_LABEL(EM_LDA_i)
dd  C_LABEL(E0_TAX)       ,C_LABEL(E0_PLB)
dd  C_LABEL(E0_LDY_a)     ,C_LABEL(EM_LDA_a)
dd  C_LABEL(E0_LDX_a)     ,C_LABEL(EM_LDA_al)
dd  C_LABEL(ALL_BCS)      ,C_LABEL(EM_LDA_OdO_y)    ; B0
dd  C_LABEL(EM_LDA_OdO)   ,C_LABEL(EM_LDA_Od_sO_y)
...
dd  C_LABEL(E0_CPY_i)     ,C_LABEL(EM_CMP_Od_xO)    ; C0
dd  C_LABEL(E0_REP)       ,C_LABEL(EM_CMP_d_s)
dd  C_LABEL(E0_CPY_d)     ,C_LABEL(EM_CMP_d)
dd  C_LABEL(EM_DEC_d)     ,C_LABEL(EM_CMP_IdI)
dd  C_LABEL(E0_INY)       ,C_LABEL(EM_CMP_i)
dd  C_LABEL(E0_DEX)       ,C_LABEL(ALL_WAI)
dd  C_LABEL(E0_CPY_a)     ,C_LABEL(EM_CMP_a)
dd  C_LABEL(EM_DEC_a)     ,C_LABEL(EM_CMP_al)
dd  C_LABEL(ALL_BNE)      ,C_LABEL(EM_CMP_OdO_y)    ; D0
dd  C_LABEL(EM_CMP_OdO)   ,C_LABEL(EM_CMP_Od_sO_y)
dd  C_LABEL(E0_PEI)       ,C_LABEL(EM_CMP_d_x)
dd  C_LABEL(EM_DEC_d_x)   ,C_LABEL(EM_CMP_IdI_y)
dd  C_LABEL(ALL_CLD)      ,C_LABEL(EM_CMP_a_y)
dd  C_LABEL(E0_PHX)       ,C_LABEL(ALL_INVALID)
dd  C_LABEL(ALL_JML_OaO)  ,C_LABEL(EM_CMP_a_x)
dd  C_LABEL(EM_DEC_a_x)   ,C_LABEL(EM_CMP_al_x)
dd  C_LABEL(E0_CPX_i)     ,C_LABEL(EM_SBC_Od_xO)    ; E0
dd  C_LABEL(E0_SEP)       ,C_LABEL(EM_SBC_d_s)
dd  C_LABEL(E0_CPX_d)     ,C_LABEL(EM_SBC_d)
dd  C_LABEL(EM_INC_d)     ,C_LABEL(EM_SBC_IdI)
dd  C_LABEL(E0_INX)       ,C_LABEL(EM_SBC_i)
dd  C_LABEL(ALL_NOP)      ,C_LABEL(ALL_XBA)
dd  C_LABEL(E0_CPX_a)     ,C_LABEL(EM_SBC_a)
dd  C_LABEL(EM_INC_a)     ,C_LABEL(EM_SBC_al)
dd  C_LABEL(ALL_BEQ)      ,C_LABEL(EM_SBC_OdO_y)    ; F0
dd  C_LABEL(EM_SBC_OdO)   ,C_LABEL(EM_SBC_Od_sO_y)
dd  C_LABEL(E0_PEA)       ,C_LABEL(EM_SBC_d_x)
dd  C_LABEL(EM_INC_d_x)   ,C_LABEL(EM_SBC_IdI_y)
dd  C_LABEL(ALL_SED)      ,C_LABEL(EM_SBC_a_y)
dd  C_LABEL(E0_PLX)       ,C_LABEL(E0_XCE)
dd  C_LABEL(E0_JSR_Oa_xO) ,C_LABEL(EM_SBC_a_x)
dd  C_LABEL(EM_INC_a_x)   ,C_LABEL(EM_SBC_al_x)
...
dd  C_LABEL(ALL_BRA)      ,C_LABEL(E0_STA_Od_xO)    ; 80
dd  C_LABEL(ALL_BRL)      ,C_LABEL(E0_STA_d_s)
dd  C_LABEL(EX_STY_d)     ,C_LABEL(E0_STA_d)
dd  C_LABEL(EX_STX_d)     ,C_LABEL(E0_STA_IdI)
dd  C_LABEL(EX_DEY)       ,C_LABEL(E0_BIT_i)
dd  C_LABEL(E0_TXA)       ,C_LABEL(E0_PHB)
dd  C_LABEL(EX_STY_a)     ,C_LABEL(E0_STA_a)
dd  C_LABEL(EX_STX_a)     ,C_LABEL(E0_STA_al)
dd  C_LABEL(ALL_BCC)      ,C_LABEL(E0_STA_OdO_y)    ; 90
dd  C_LABEL(E0_STA_OdO)   ,C_LABEL(E0_STA_Od_sO_y)
dd  C_LABEL(EX_STY_d_x)   ,C_LABEL(E0_STA_d_x)
dd  C_LABEL(EX_STX_d_y)   ,C_LABEL(E0_STA_IdI_y)
dd  C_LABEL(E0_TYA)       ,C_LABEL(E0_STA_a_y)
...
dd  C_LABEL(EX_TAY)       ,C_LABEL(E0_LDA_i)
dd  C_LABEL(EX_TAX)       ,C_LABEL(E0_PLB)
dd  C_LABEL(EX_LDY_a)     ,C_LABEL(E0_LDA_a)
dd  C_LABEL(EX_LDX_a)     ,C_LABEL(E0_LDA_al)
dd  C_LABEL(ALL_BCS)      ,C_LABEL(E0_LDA_OdO_y)    ; B0
dd  C_LABEL(E0_LDA_OdO)   ,C_LABEL(E0_LDA_Od_sO_y)
...
dd  C_LABEL(EX_CPY_i)     ,C_LABEL(E0_CMP_Od_xO)    ; C0
dd  C_LABEL(E0_REP)       ,C_LABEL(E0_CMP_d_s)
dd  C_LABEL(EX_CPY_d)     ,C_LABEL(E0_CMP_d)
dd  C_LABEL(E0_DEC_d)     ,C_LABEL(E0_CMP_IdI)
dd  C_LABEL(EX_INY)       ,C_LABEL(E0_CMP_i)
dd  C_LABEL(EX_DEX)       ,C_LABEL(ALL_WAI)
dd  C_LABEL(EX_CPY_a)     ,C_LABEL(E0_CMP_a)
dd  C_LABEL(E0_DEC_a)     ,C_LABEL(E0_CMP_al)
dd  C_LABEL(ALL_BNE)      ,C_LABEL(E0_CMP_OdO_y)    ; D0
dd  C_LABEL(E0_CMP_OdO)   ,C_LABEL(E0_CMP_Od_sO_y)
dd  C_LABEL(E0_PEI)       ,C_LABEL(E0_CMP_d_x)
...
dd  C_LABEL(ALL_JML_OaO)  ,C_LABEL(E0_CMP_a_x)
dd  C_LABEL(E0_DEC_a_x)   ,C_LABEL(E0_CMP_al_x)
dd  C_LABEL(EX_CPX_i)     ,C_LABEL(E0_SBC_Od_xO)    ; E0
dd  C_LABEL(E0_SEP)       ,C_LABEL(E0_SBC_d_s)
dd  C_LABEL(EX_CPX_d)     ,C_LABEL(E0_SBC_d)
dd  C_LABEL(E0_INC_d)     ,C_LABEL(E0_SBC_IdI)
dd  C_LABEL(EX_INX)       ,C_LABEL(E0_SBC_i)
dd  C_LABEL(ALL_NOP)      ,C_LABEL(ALL_XBA)
dd  C_LABEL(EX_CPX_a)     ,C_LABEL(E0_SBC_a)
dd  C_LABEL(E0_INC_a)     ,C_LABEL(E0_SBC_al)
dd  C_LABEL(ALL_BEQ)      ,C_LABEL(E0_SBC_OdO_y)    ; F0
dd  C_LABEL(E0_SBC_OdO)   ,C_LABEL(E0_SBC_Od_sO_y)
dd  C_LABEL(E0_PEA)       ,C_LABEL(E0_SBC_d_x)
...
dd  C_LABEL(ALL_BRA)      ,C_LABEL(EM_STA_Od_xO)    ; 80
dd  C_LABEL(ALL_BRL)      ,C_LABEL(EM_STA_d_s)
dd  C_LABEL(EX_STY_d)     ,C_LABEL(EM_STA_d)
dd  C_LABEL(EX_STX_d)     ,C_LABEL(EM_STA_IdI)
dd  C_LABEL(EX_DEY)       ,C_LABEL(EM_BIT_i)
dd  C_LABEL(EM_TXA)       ,C_LABEL(E0_PHB)
dd  C_LABEL(EX_STY_a)     ,C_LABEL(EM_STA_a)
dd  C_LABEL(EX_STX_a)     ,C_LABEL(EM_STA_al)
dd  C_LABEL(ALL_BCC)      ,C_LABEL(EM_STA_OdO_y)    ; 90
dd  C_LABEL(EM_STA_OdO)   ,C_LABEL(EM_STA_Od_sO_y)
dd  C_LABEL(EX_STY_d_x)   ,C_LABEL(EM_STA_d_x)
dd  C_LABEL(EX_STX_d_y)   ,C_LABEL(EM_STA_IdI_y)
dd  C_LABEL(EM_TYA)       ,C_LABEL(EM_STA_a_y)
dd  C_LABEL(E0_TXS)       ,C_LABEL(EX_TXY)
dd  C_LABEL(EM_STZ_a)     ,C_LABEL(EM_STA_a_x)
dd  C_LABEL(EM_STZ_a_x)   ,C_LABEL(EM_STA_al_x)
...
dd  C_LABEL(EX_TAY)       ,C_LABEL(EM_LDA_i)
dd  C_LABEL(EX_TAX)       ,C_LABEL(E0_PLB)
dd  C_LABEL(EX_LDY_a)     ,C_LABEL(EM_LDA_a)
dd  C_LABEL(EX_LDX_a)     ,C_LABEL(EM_LDA_al)
dd  C_LABEL(ALL_BCS)      ,C_LABEL(EM_LDA_OdO_y)    ; B0
dd  C_LABEL(EM_LDA_OdO)   ,C_LABEL(EM_LDA_Od_sO_y)
...
dd  C_LABEL(EX_CPY_i)     ,C_LABEL(EM_CMP_Od_xO)    ; C0
dd  C_LABEL(E0_REP)       ,C_LABEL(EM_CMP_d_s)
dd  C_LABEL(EX_CPY_d)     ,C_LABEL(EM_CMP_d)
dd  C_LABEL(EM_DEC_d)     ,C_LABEL(EM_CMP_IdI)
dd  C_LABEL(EX_INY)       ,C_LABEL(EM_CMP_i)
dd  C_LABEL(EX_DEX)       ,C_LABEL(ALL_WAI)
dd  C_LABEL(EX_CPY_a)     ,C_LABEL(EM_CMP_a)
dd  C_LABEL(EM_DEC_a)     ,C_LABEL(EM_CMP_al)
dd  C_LABEL(ALL_BNE)      ,C_LABEL(EM_CMP_OdO_y)    ; D0
dd  C_LABEL(EM_CMP_OdO)   ,C_LABEL(EM_CMP_Od_sO_y)
dd  C_LABEL(E0_PEI)       ,C_LABEL(EM_CMP_d_x)
...
dd  C_LABEL(ALL_JML_OaO)  ,C_LABEL(EM_CMP_a_x)
dd  C_LABEL(EM_DEC_a_x)   ,C_LABEL(EM_CMP_al_x)
dd  C_LABEL(EX_CPX_i)     ,C_LABEL(EM_SBC_Od_xO)    ; E0
dd  C_LABEL(E0_SEP)       ,C_LABEL(EM_SBC_d_s)
dd  C_LABEL(EX_CPX_d)     ,C_LABEL(EM_SBC_d)
dd  C_LABEL(EM_INC_d)     ,C_LABEL(EM_SBC_IdI)
dd  C_LABEL(EX_INX)       ,C_LABEL(EM_SBC_i)
dd  C_LABEL(ALL_NOP)      ,C_LABEL(ALL_XBA)
dd  C_LABEL(EX_CPX_a)     ,C_LABEL(EM_SBC_a)
dd  C_LABEL(EM_INC_a)     ,C_LABEL(EM_SBC_al)
dd  C_LABEL(ALL_BEQ)      ,C_LABEL(EM_SBC_OdO_y)    ; F0
dd  C_LABEL(EM_SBC_OdO)   ,C_LABEL(EM_SBC_Od_sO_y)
dd  C_LABEL(E0_PEA)       ,C_LABEL(EM_SBC_d_x)
...
dd  C_LABEL(E1_COP)       ,C_LABEL(EM_ORA_d_s)
dd  C_LABEL(EM_TSB_d)     ,C_LABEL(EM_ORA_d)
dd  C_LABEL(EM_ASL_d)     ,C_LABEL(EM_ORA_IdI)
dd  C_LABEL(E1_PHP)       ,C_LABEL(EM_ORA_i)
dd  C_LABEL(EM_SLA)       ,C_LABEL(E1_PHD)
dd  C_LABEL(EM_TSB_a)     ,C_LABEL(EM_ORA_a)
dd  C_LABEL(EM_ASL_a)     ,C_LABEL(EM_ORA_al)
dd  C_LABEL(ALL_BPL)      ,C_LABEL(EM_ORA_OdO_y)    ; 10
dd  C_LABEL(EM_ORA_OdO)   ,C_LABEL(EM_ORA_Od_sO_y)
...
dd  C_LABEL(EM_ASL_d_x)   ,C_LABEL(EM_ORA_IdI_y)
dd  C_LABEL(ALL_CLC)      ,C_LABEL(EM_ORA_a_y)
dd  C_LABEL(EM_INA)       ,C_LABEL(E1_TCS)
dd  C_LABEL(EM_TRB_a)     ,C_LABEL(EM_ORA_a_x)
dd  C_LABEL(EM_ASL_a_x)   ,C_LABEL(EM_ORA_al_x)
dd  C_LABEL(E1_JSR_a)     ,C_LABEL(EM_AND_Od_xO)    ; 20
dd  C_LABEL(E1_JSL_al)    ,C_LABEL(EM_AND_d_s)
dd  C_LABEL(EM_BIT_d)     ,C_LABEL(EM_AND_d)
dd  C_LABEL(EM_ROL_d)     ,C_LABEL(EM_AND_IdI)
dd  C_LABEL(E1_PLP)       ,C_LABEL(EM_AND_i)
dd  C_LABEL(EM_RLA)       ,C_LABEL(E1_PLD)
dd  C_LABEL(EM_BIT_a)     ,C_LABEL(EM_AND_a)
dd  C_LABEL(EM_ROL_a)     ,C_LABEL(EM_AND_al)
dd  C_LABEL(ALL_BMI)      ,C_LABEL(EM_AND_OdO_y)    ; 30
dd  C_LABEL(EM_AND_OdO)   ,C_LABEL(EM_AND_Od_sO_y)
...
dd  C_LABEL(EM_LSR_d)     ,C_LABEL(EM_EOR_IdI)
dd  C_LABEL(EM_PHA)       ,C_LABEL(EM_EOR_i)
dd  C_LABEL(EM_SRA)       ,C_LABEL(E1_PHK)
dd  C_LABEL(ALL_JMP_a)    ,C_LABEL(EM_EOR_a)
dd  C_LABEL(EM_LSR_a)     ,C_LABEL(EM_EOR_al)
dd  C_LABEL(ALL_BVC)      ,C_LABEL(EM_EOR_OdO_y)    ; 50
dd  C_LABEL(EM_EOR_OdO)   ,C_LABEL(EM_EOR_Od_sO_y)
dd  C_LABEL(EX_MVN)       ,C_LABEL(EM_EOR_d_x)
dd  C_LABEL(EM_LSR_d_x)   ,C_LABEL(EM_EOR_IdI_y)
dd  C_LABEL(E1_CLI)       ,C_LABEL(EM_EOR_a_y)
...
dd  C_LABEL(EM_RRA)       ,C_LABEL(E1_RTL)
dd  C_LABEL(ALL_JMP_OaO)  ,C_LABEL(EM_ADC_a)
dd  C_LABEL(EM_ROR_a)     ,C_LABEL(EM_ADC_al)
dd  C_LABEL(ALL_BVS)      ,C_LABEL(EM_ADC_OdO_y)    ; 70
dd  C_LABEL(EM_ADC_OdO)   ,C_LABEL(EM_ADC_Od_sO_y)
...
dd  C_LABEL(EX_LDX_a_y)   ,C_LABEL(EM_LDA_al_x)
dd  C_LABEL(EX_CPY_i)     ,C_LABEL(EM_CMP_Od_xO)    ; C0
dd  C_LABEL(E1_REP)       ,C_LABEL(EM_CMP_d_s)
dd  C_LABEL(EX_CPY_d)     ,C_LABEL(EM_CMP_d)
dd  C_LABEL(EM_DEC_d)     ,C_LABEL(EM_CMP_IdI)
dd  C_LABEL(EX_INY)       ,C_LABEL(EM_CMP_i)
dd  C_LABEL(EX_DEX)       ,C_LABEL(ALL_WAI)
...
dd  C_LABEL(EM_DEC_a_x)   ,C_LABEL(EM_CMP_al_x)
dd  C_LABEL(EX_CPX_i)     ,C_LABEL(EM_SBC_Od_xO)    ; E0
dd  C_LABEL(E1_SEP)       ,C_LABEL(EM_SBC_d_s)
dd  C_LABEL(EX_CPX_d)     ,C_LABEL(EM_SBC_d)
dd  C_LABEL(EM_INC_d)     ,C_LABEL(EM_SBC_IdI)
dd  C_LABEL(EX_INX)       ,C_LABEL(EM_SBC_i)
dd  C_LABEL(ALL_NOP)      ,C_LABEL(ALL_XBA)
