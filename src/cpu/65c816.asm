...
dd  C_LABEL(E0_LDX_a_y)   ,C_LABEL(OpM0_0xBF)
...
dd  C_LABEL(E0_LDX_a_y)   ,C_LABEL(OpM1_0xBF)
...
dd  C_LABEL(EX_LDX_a_y)   ,C_LABEL(OpM0_0xBF)
...
dd  C_LABEL(EX_LDX_a_y)   ,C_LABEL(OpM1_0xBF)
