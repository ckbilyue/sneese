...
dd  C_LABEL(OpX0_0xBC)    ,C_LABEL(E0_LDA_a_x)
...
dd  C_LABEL(E0_TSX)       ,C_LABEL(E0_TYX)
dd  C_LABEL(OpX0_0xBC)    ,C_LABEL(EM_LDA_a_x)
...
dd  C_LABEL(OpX1_0xBC)    ,C_LABEL(E0_LDA_a_x)
...
dd  C_LABEL(ALL_CLV)      ,C_LABEL(EM_LDA_a_y)
dd  C_LABEL(EX_TSX)       ,C_LABEL(EX_TYX)
dd  C_LABEL(OpX1_0xBC)    ,C_LABEL(EM_LDA_a_x)
